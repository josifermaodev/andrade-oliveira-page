        ...
        <section className="container mx-auto flex flex-col items-center justify-center gap-4 pt-10 px-4 md:px-6">
            ...
            <div className="flex flex-col lg:flex-row items-center justify-center gap-4 p-4 ">
                <div className="flex items-center justify-center gap-4 p-4">
                    <Image src="worker.svg" alt="Icone de engenheiro" className="w-15"/>
                    <div>
                ...
                <div className="flex items-center justify-center gap-4 p-4">
                    <Image src="guaranteed.svg" alt="Icone de engenheiro" className="w-15"/>
                    <div>
                ...
                <div className="flex items-center justify-center gap-4 p-4">
                    <Image src="quality.svg" alt="Icone de engenheiro" className="w-15"/>
                    <div>
